...
# pair
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../my_pair/release/ -lmy_pair
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../my_pair/debug/ -lmy_pair
else:unix: LIBS += -L$$OUT_PWD/../my_pair/ -lmy_pair

INCLUDEPATH += $$PWD/../my_pair
DEPENDPATH += $$PWD/../my_pair

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../my_pair/release/libmy_pair.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../my_pair/debug/libmy_pair.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../my_pair/release/my_pair.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../my_pair/debug/my_pair.lib
else:unix: PRE_TARGETDEPS += $$OUT_PWD/../my_pair/libmy_pair.a
...
# string
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../my_string/release/ -lmy_string
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../my_string/debug/ -lmy_string
else:unix: LIBS += -L$$OUT_PWD/../my_string/ -lmy_string
